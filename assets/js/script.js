		...
		if (flag && lastSearch != e.target.value){
			...
			$.ajax({
				...
				success: function(ret){
					...
					container = document.getElementsByClassName("nearby-contct")[0]
					...
					<div class="nearly-pepls">\
							...
							<div class="pepl-info">\
								...
								<a href="#" title="" username="" class="add-butn" data-ripple="">Add Friend</a>\
							</div>\
						</div>\
					</li>`
					...
					for(var i=0; i<ret.length; i++){
						...
						latest_block = container.getElementsByTagName("li")[i]
						latest_block.getElementsByTagName("img")[0].src = ret.imageURL
						latest_block.getElementsByClassName("pepl-info")[0].getElementsByTagName("a")[0].innerText = ret.fullname
						latest_block.getElementsByClassName("pepl-info")[0].getElementsByTagName("a")[0].href = "/timeline?u="+ret.username
						latest_block.getElementsByTagName("figure")[0].getElementsByTagName("a").href = "/timeline?u="+ret.username
